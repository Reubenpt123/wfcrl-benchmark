...
idqn_eval="python /home/reuben/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $idqn_model --episode_length $episode_length --scenario $scenario --algo idqn --hidden_layer_nn 64"
...
#idrqn_eval="python /home/reuben/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $idrqn_model --episode_length $episode_length --scenario $scenario --algo idrqn --hidden_layer_nn 64 64"
...
#ippo_eval="python /home/reuben/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $ippo_model --episode_length $episode_length --scenario $scenario --algo ippo --hidden_layer_nn 64 64"
...
#mappo_eval="python /home/reuben/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $mappo_model --episode_length $episode_length --scenario $scenario --algo mappo --hidden_layer_nn 64 64"
...
#qmix_eval="python /home/reuben/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $qmix_model --episode_length $episode_length --scenario $scenario --algo qmix --hidden_layer_nn 64"
