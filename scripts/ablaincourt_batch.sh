...
idqn_eval="python ~/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $idqn_model --$track --wandb_project_name $wandb_project_name --episode_length $episode_length --scenario $scenario"
...
#idrqn_eval="python ~/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $idrqn_model --$track --wandb_project_name $wandb_project_name --episode_length $episode_length --scenario $scenario"
...
#ippo_eval="python ~/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $ippo_model --$track --wandb_project_name $wandb_project_name --episode_length $episode_length --scenario $scenario"
...
#mappo_eval="python ~/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $mappo_model --$track --wandb_project_name $wandb_project_name --episode_length $episode_length --scenario $scenario"
...
#qmix_eval="python ~/code/wfcrl-benchmark/algos/eval.py --seed 0 --env_id Dec_Ablaincourt_Fastfarm --pretrained_models $qmix_model --$track --wandb_project_name $wandb_project_name --episode_length $episode_length --scenario $scenario"
